...
const Offcanvas = (row, rowIndex, formatExtraData) => {
  ...
  const editLink = `/ratel/administration/phonebookentries/editEntry?tenantDomain=${tenant.customerId}&ID=${row.ID}`
  //console.log(row)
  return (
    <>
      <Link to={editLink}>
...
const PhonebookEntryList = () => {
  const tenant = useSelector((state) => state.app.currentTenant)
  const addPhonebookEntryButton = <TitleButton href="ratel/administration/phonebookentries/add" title="Add Phonebook Entry" />
  return (
    <CippPageList
